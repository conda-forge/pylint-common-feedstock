About pylint-common-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pylint-common-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5695&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pylint-common-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pylint-common` can be installed with `conda`:
...
```
mamba install pylint-common
```

It is possible to list all of the versions of `pylint-common` available on your platform with `conda`:
...
```
mamba search pylint-common --channel conda-forge
```
...
mamba repoquery search pylint-common --channel conda-forge

# List packages depending on `pylint-common`:
mamba repoquery whoneeds pylint-common --channel conda-forge

# List dependencies of `pylint-common`:
mamba repoquery depends pylint-common --channel conda-forge
```
